...
## 如何报名参加？
  ...
  我已经根据一期开发的目标在写初始代码。我相信大家肯定是很感兴趣的，但必然有很多人会因为时间精力等各种原因还没法直接参与开发。其实做贡献的方式有很多种，除了PR，也很欢迎大家能提出各种需求，提BUG，如果有一定兴趣，那么：

  1. 请Fork这个项目，把你的GITHUB账号名字加到[./members.md](./members.md)那个文件，然后提交PR，等待合并。
