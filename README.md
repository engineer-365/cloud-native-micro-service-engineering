...
## 想法：
   ...
   - 坚持做自动化测试：单元测试、集成测试、性能测试、压力测试、端对端功能测试。测试覆盖率100%。（题外话：很多其他开源的产品演示性项目单元测试是0）。
...
- 太多了，一看就跟不上，就连这个简介都看不懂
  ...
  现在的趋势就是云原生、微服务、DevOps，列出的这些技术就是在跟着大趋势走，避免走弯路，避免重复发明轮子，希望走在了主流的前列里面。因此，目前为止，很多技术要么只能在它们的官方网站上才学得到，要么在网上零零散散的而且大部分还是重复的或过时的，跟着书学或跟着培训班学效果不好，而且很可能也学到的都是过时的。真正的技术只可能在系统化的实践中才学得到学得好。
...
- 我不喜欢或者不习惯你提到的技术，或者我觉得应该尝试一些更新的技术，能不能换成xx？譬如，有群友说：“最近正好有计划做一个类似的，想做的平台是基于vertex的kotlin和actix的rust，以及尽量全套的异步组件，顺便试试postgresql。”
  
  有一定经验的程序员会觉得上面列的这些技术虽然看似多得有些唬人，但其实大部分是些成熟的东西，不算前沿。这个选择策略是刻意的，一方面我自己也不是这些都接触和熟悉，所以想借此多多实践下，另一方面，其实和为我自己一样，这个项目的目标就不是调研和尝新，是让大家有机会实践尽可能真实的正规工程开发，摆脱书本教程，摆脱作坊式开发，“站到巨人的肩膀上”（这个巨人不是指这个项目，是指这些成熟的主流技术）。

  既然定位于系统的接近真实正规工程环境的学习性演示性项目，而不是前沿探索性的项目或产品，那么必然涉及的方方面面的细节会很多很杂，从提高项目成功的可能性来说，我也刻意采取了保守的技术选择策略，至少在前两阶段是这样的，打个比方，我们一起去创业做个公司，那么第一目标必须是能迅速拿出mvp产品，在拿到市场反馈和反复调整产品迎合市场需求，技术成熟好用更重要。迭代取得了阶段性成果以后，我们就会更有士气有精力有机会去实践更多的方案。

  所以，拿上面这个问题提到的“异步/非阻塞”的话题来说，Java里异步还没成主流，我的主要想法之一是先用主流的东西，有了一个平台，再在这个平台上尝试别的
